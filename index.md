...
2. all the Code.  
You can use the button to see the code [Code](https://github.com/zhanghfan/learnPython/blob/master/code/README.md)
3. data structures and algorithms.  
You can use the button to see th data structures and algorithms [DSA](https://github.com/zhanghfan/learnPython/blob/master/dsa/README.md)
